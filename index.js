  ...
  "defines": [
    {
      ...
      "@type": "rdf:Property",
      "label": "repository",
      "comment":"Array of repositories where the package can be located.",
      "range": "schema:Code",
    ...
    },
    {
      ...
      "@type": "rdf:Property",
      "label": "input",
      "comment":"List of URLs of data used in a given analysis.",
      "range": "xsd:string",
      "domain": "schema:Code",
      "status": "testing",
      "seeAlso": "http://schema.org/Code"
    },
    {
      ...
      "@type": "rdf:Property",
      "label": "output",
      "comment":"List of URLs of data generated in a given analysis.",
      "range": "xsd:string",
      "domain": "schema:Code",
      "status": "testing",
      "seeAlso": "http://schema.org/Code"
